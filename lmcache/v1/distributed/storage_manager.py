    ...
    def query_prefetch_status(
        ...
        *,
        ...
        Args:
            ...
            pop: If True (default), consume the result from the
                prefetch controller (exactly-once semantics).
                If False, peek without consuming — the result
                stays for later cleanup.
